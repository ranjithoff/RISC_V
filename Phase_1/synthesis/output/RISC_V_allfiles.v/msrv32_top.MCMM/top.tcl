## created by version 2.0 write_timing_context -format icc2 -output ../output/RISC_V_allfiles.v/msrv32_top.MCMM 
puts "Information: sourcing [info script]";
remove_modes -all;remove_corners -all;remove_scenarios -all;
namespace eval 68D17F1B {
