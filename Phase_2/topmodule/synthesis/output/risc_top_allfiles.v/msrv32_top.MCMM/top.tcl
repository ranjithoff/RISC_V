## created by version 2.0 write_timing_context -format icc2 -output ../output/risc_top_allfiles.v/msrv32_top.MCMM 
puts "Information: sourcing [info script]";
remove_modes -all;remove_corners -all;remove_scenarios -all;
namespace eval 691F243D {
