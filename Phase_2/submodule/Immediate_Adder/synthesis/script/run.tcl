...
create_mw_lib -technology $TECH_FILE -mw_reference_library $REFLIB immediate_adder.mw -open
		
################################################################################################################
## Read/Convert to WV GEtech/Connet Sub block to TOP block
################################################################################################################

analyze -format verilog ../../../../../../router_pnr_flow/routericc2flow/rtl/msrv32_immediate_adder.v 
...
write_icc2_files -output ../output/immediate_adder_allfiles.v
write_file -format verilog -hierarchy -output ../output/immediate_adder_Netlist.v
