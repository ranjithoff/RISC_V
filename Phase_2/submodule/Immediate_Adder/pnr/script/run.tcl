##############################################################################################################
# Major Project (Sub Block - Immediate_adder)
# Script: run.tcl
##############################################################################################################
...
create_lib -technology $TECH_FLIE -ref_libs $REFERENCE_LIBRARY Immediate_adder.dlib
read_verilog ../../synthesis/output/immediate_adder_Netlist.v
current_design
...
report_lib -parasitic_tech Immediate_adder.dlib
...
reset_upf
load_upf ../script/immediate_adder.upf 
commit_upf
check_mv_design
...
save_block -as Immediate_adder/1_initial_design
...
source ../script/immediate_adder_pns.tcl
...
save_block -as Immediate_adder/2_Placement_done
...
save_block -as Immediate_adder/3_routing_done
...
save_block -as Immediate_adder/4_filler_done
...
write_gds ../output/Immediate_adder.gds

save_block -as Immediate_adder/5_file_generator_done
