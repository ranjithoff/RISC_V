...
create_scenario -name immediate_adder -mode default -corner default
report_scenarios
set_scenario_status immediate_adder -active true -setup false -hold false -max_transition true \
