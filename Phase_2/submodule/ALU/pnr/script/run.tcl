...
create_lib -technology $TECH_FLIE -ref_libs $REFERENCE_LIBRARY alu.dlib
read_verilog ../../synthesis/output/alu_Netlist.v
current_design
...
report_lib -parasitic_tech alu.dlib
...
save_block -as alu/1_initial_design
...
save_block -as alu/2_Placement_done
...
save_block -as alu/3_routing_done
...
save_block -as alu/4_filler_done
...
write_gds ../output/alu.gds

save_block -as alu/5_file_generator_done
