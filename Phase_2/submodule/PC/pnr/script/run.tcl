...
create_lib -technology $TECH_FLIE -ref_libs $REFERENCE_LIBRARY PC.dlib
read_verilog ../../synthesis/output/PC_Netlist.v
current_design
...
report_lib -parasitic_tech PC.dlib
...
save_block -as PC/1_initial_design
...
save_block -as PC/2_Placement_done
...
save_block -as PC/3_routing_done
...
save_block -as PC/4_filler_done
...
write_gds ../output/PC.gds

save_block -as PC/5_file_generator_done
