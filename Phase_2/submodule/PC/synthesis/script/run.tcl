...
create_mw_lib -technology $TECH_FILE -mw_reference_library $REFLIB PC.mw -open
		
################################################################################################################
## Read/Convert to WV GEtech/Connet Sub block to TOP block
################################################################################################################

analyze -format verilog ../../../../../../router_pnr_flow/routericc2flow/rtl/msrv32_pc.v 
elaborate msrv32_pc
link
current_design
...
write_icc2_files -output ../output/PC_allfiles.v
write_file -format verilog -hierarchy -output ../output/PC_Netlist.v
